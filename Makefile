...
link_test_bfs: $(objects_test_bfs) $(output_bfs)
	@echo "Testing"
link_test_arraylist: $(objects_test_arraylist) $(output_arraylist)
	@echo "Testing"
link_test_algorithm: $(objects_test_algorithm) $(output_algorithm)
	@echo "Testing"
...
# 	-$(CPP) $(CPPFLAGS) -E $< > $@
PA/Element.i : PA/Element.c
	$(CPP) $(CPPFLAGS) -E $(srcdir)/$< > $(srcdir)/$@
PA/Count.i : PA/Count.c
	$(CPP) $(CPPFLAGS) -E $(srcdir)/$< > $(srcdir)/$@
PA/Pair.i : PA/Pair.c
	$(CPP) $(CPPFLAGS) -E $(srcdir)/$< > $(srcdir)/$@
PA/Result.i : PA/Result.c
	$(CPP) $(CPPFLAGS) -E $(srcdir)/$< > $(srcdir)/$@
PA/Series.i : PA/Series.c
	$(CPP) $(CPPFLAGS) -E $(srcdir)/$< > $(srcdir)/$@
PA/Status.i : PA/Status.c
	$(CPP) $(CPPFLAGS) -E $(srcdir)/$< > $(srcdir)/$@
# src/PA/Feature.i : src/PA/Feature.c include/PA/Feature.h include/types.h
# 	-$(CPP) $(CPPFLAGS) -E $< > $@
PA/Value.i : PA/Value.c
	$(CPP) $(CPPFLAGS) -E $(srcdir)/$< > $(srcdir)/$@
PA/Resource.i : PA/Resource.c
	$(CPP) $(CPPFLAGS) -E $(srcdir)/$< > $(srcdir)/$@	
PA/NormalTree.i : PA/NormalTree.c
	$(CPP) $(CPPFLAGS) -E $(srcdir)/$< > $(srcdir)/$@
PA/Number.i : PA/Number.c
	$(CPP) $(CPPFLAGS) -E $(srcdir)/$< > $(srcdir)/$@
PA/TransposeTree.i : PA/TransposeTree.c
	$(CPP) $(CPPFLAGS) -E $(srcdir)/$< > $(srcdir)/$@
PA/PADrawingEditor.i : PA/PADrawingEditor.c
	$(CPP) $(CPPFLAGS) -E $(srcdir)/$< > $(srcdir)/$@
PA/PALine.i : PA/PALine.c
	$(CPP) $(CPPFLAGS) -E $(srcdir)/$< > $(srcdir)/$@
PA/PAShape.i : PA/PAShape.c
	$(CPP) $(CPPFLAGS) -E $(srcdir)/$< > $(srcdir)/$@
PA/PATextView.i : PA/PATextView.c 
	$(CPP) $(CPPFLAGS) -E $(srcdir)/$< > $(srcdir)/$@
PA/Arrow.i : PA/Arrow.c
	$(CPP) $(CPPFLAGS) -E $(srcdir)/$< > $(srcdir)/$@
PA/Destination.i : PA/Destination.c
	$(CPP) $(CPPFLAGS) -E $(srcdir)/$< > $(srcdir)/$@
PA/Feature.i : PA/Feature.c
	$(CPP) $(CPPFLAGS) -E $(srcdir)/$< > $(srcdir)/$@
...
PA/PATextView.s: PA/PATextView.i
	$(CC) -S $(srcdir)/$< -o $(srcdir)/$@
PA/Feature.s: PA/Feature.i
	$(CC) -S $(srcdir)/$< -o $(srcdir)/$@
PA/Arrow.s: PA/Arrow.i
	$(CC) -S $(srcdir)/$< -o $(srcdir)/$@
PA/Destination.s: PA/Destination.i
	$(CC) -S $(srcdir)/$< -o $(srcdir)/$@
...
PA/Destination.o: PA/Destination.s
ifeq ($(host-type),arm64)
	$(AS) $(ASFLAGS) $(srcdir)/$< -o $(libdir)/$@
endif
ifeq ($(host-type),x86_64)
