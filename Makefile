...
#	rm -v $(foreach binary,$(output_pa),$(bindir)/$(binary))
# 	-rm $(objects_pa)
# 	-rm $(assemblies_pa)
# 	-rm $(sources_pa)
#
...
Input.i : src/Input.c
	$(CPP) $(CPPFLAGS) -E $< > src/$@
Algorithm.i : src/Algorithm.c
	$(CPP) $(CPPFLAGS) -E $< > src/$@
BFS/Procedure.i : src/BFS/Procedure.c
	$(CPP) $(CPPFLAGS) -E $< > src/$@
PA/Input.i : src/PA/Input.c
	$(CPP) $(CPPFLAGS) -E $< > src/$@
PA/Output.i : src/PA/Output.c
	$(CPP) $(CPPFLAGS) -E $< > src/$@
BFS/Record.i : src/BFS/Record.c
	$(CPP) $(CPPFLAGS) -E $< > src/$@
Output.i : src/Output.c
	$(CPP) $(CPPFLAGS) -E $< > src/$@
PA/Data.i : src/PA/Data.c
	$(CPP) $(CPPFLAGS) -E $< > src/$@
PA/Memory.i : src/PA/Memory.c
	$(CPP) $(CPPFLAGS) -E $< > src/$@
PA/Object.i : src/PA/Object.c
	$(CPP) $(CPPFLAGS) -E $< > src/$@
# src/PA/Destination.i : src/PA/Destination.c include/types.h include/PA/Destination.h
# 	-$(CPP) $(CPPFLAGS) -E $< > $@
PA/Tree.i : src/PA/Tree.c
	$(CPP) $(CPPFLAGS) -E $< > src/$@
PA/List.i : src/PA/List.c
	$(CPP) $(CPPFLAGS) -E $< > src/$@
PA/Link.i : src/PA/Link.c
	$(CPP) $(CPPFLAGS) -E $< > src/$@
# src/PA/Arrow.i : src/PA/Arrow.c include/defs.h include/PA/Arrow.h include/types.h
# 	-$(CPP) $(CPPFLAGS) -E $< > $@
PA/Element.i : src/PA/Element.c
	$(CPP) $(CPPFLAGS) -E $< > src/$@
PA/Count.i : src/PA/Count.c
	$(CPP) $(CPPFLAGS) -E $< > src/$@
PA/Pair.i : src/PA/Pair.c
	$(CPP) $(CPPFLAGS) -E $< > src/$@
PA/Result.i : src/PA/Result.c
	$(CPP) $(CPPFLAGS) -E $< > src/$@
PA/Series.i : src/PA/Series.c
	$(CPP) $(CPPFLAGS) -E $< > src/$@
PA/Status.i : src/PA/Status.c
	$(CPP) $(CPPFLAGS) -E $< > src/$@
# src/PA/Feature.i : src/PA/Feature.c include/PA/Feature.h include/types.h
# 	-$(CPP) $(CPPFLAGS) -E $< > $@
PA/Value.i : src/PA/Value.c
	$(CPP) $(CPPFLAGS) -E $< > src/$@
PA/Resource.i : src/PA/Resource.c
	$(CPP) $(CPPFLAGS) -E $< > src/$@	
PA/NormalTree.i : src/PA/NormalTree.c
	$(CPP) $(CPPFLAGS) -E $< > src/$@
PA/Number.i : src/PA/Number.c
	$(CPP) $(CPPFLAGS) -E $< > src/$@
PA/TransposeTree.i : src/PA/TransposeTree.c
	$(CPP) $(CPPFLAGS) -E $< > src/$@
PA/PADrawingEditor.i : src/PA/PADrawingEditor.c
	$(CPP) $(CPPFLAGS) -E $< > src/$@
PA/PALine.i : src/PA/PALine.c
	$(CPP) $(CPPFLAGS) -E $< > src/$@
PA/PAShape.i : src/PA/PAShape.c
	$(CPP) $(CPPFLAGS) -E $< > src/$@
PA/PATextView.i : src/PA/PATextView.c
	$(CPP) $(CPPFLAGS) -E $< > src/$@
ArrayList/ArrayList.i: src/ArrayList/ArrayList.c
	$(CPP) $(CPPFLAGS) -E $< > src/$@
ArrayList/ArrayListPosition.i : src/ArrayList/ArrayListPosition.c
	$(CPP) $(CPPFLAGS) -E $< > src/$@
PA/Size.i : src/PA/Size.c
	$(CPP) $(CPPFLAGS) -E $< > src/$@
