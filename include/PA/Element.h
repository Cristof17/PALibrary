...
DllExport struct PAElement* PAElementPerformCreate();
...
DllExport int PAElementPerformFinish(struct PAElement*);
DllExport int PAElementPerformDelete(struct PAElement*);
