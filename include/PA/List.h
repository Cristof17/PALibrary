...
DllExport struct PAList PASeriesPerformConstruct(struct PACount n, struct PASeries series);
...
DllExport struct PAList PAListPerformDelete(struct PACount, struct PASeries PA);
