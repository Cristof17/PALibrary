...
DllExport struct PACount PACountCompleteBegin(struct PACount* Count, struct PANumber Number);
DllExport struct void PACountCopy(struct PACount* from, struct PACount* to);
