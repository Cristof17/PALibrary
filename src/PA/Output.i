...
# 6 "src/PA/Output.c" 2
# 58 "src/PA/Output.c"
          struct BFSRecord OutputPerformConstruct(struct BFSRecord record);

          int PAOutputPerformInit(struct BFSRecord record)
{
    return 0;
}

          int PAOutputPerformRuin(struct BFSRecord Result);
          int PAOutputPerformDelete(struct Output Out);
          void PAOutputPerformPrint(PAResult);
