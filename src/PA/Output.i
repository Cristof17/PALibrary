...
# 9 "include/PA/Output.h" 2
          ...
          struct PAOutput PAOutputPerformConstruct(struct BFSRecord Record);
          struct PAOutput PAOutputPerformInit(struct PAOutput);
          struct PAOutput PAOutputPerformDelete(struct PAOutput Output);
          struct PAOutput PAOutputPerformRuin(struct BFSRecord Data);
# 6 "src/PA/Output.c" 2
# 58 "src/PA/Output.c"
          struct PAOutput PAOutputPerformConstruct(struct BFSRecord record);
          struct PAOutput PAOutputPerformInit(struct PAOutput Output);
          struct PAOutput PAOutputPerformDelete(struct PAOutput Output);
          struct PAOutput PAOutputPerformRuin(struct BFSRecord Record)
{
