...
# 11 "./include/PA/Link.h" 2
          ...
          static Object PALinkPerformCopy(Object, Object, size_t);



          int PALinkPerformDelete(PALink);
# 9 "src/PA/Link.c" 2
...
# 10 "src/PA/Link.c" 2
          ...
          Memory PALinkPerformConstruct(size_t size)
{
...
# 52 "src/PA/Link.c"
    return aux;
          ...
          static Object PALinkPerformCopy(Object from, Object to, size_t size)
{
...
# 79 "src/PA/Link.c"
    ...
    return returnCode;
          ...
          int PALinkPerformRuin(Memory Pair)
{
