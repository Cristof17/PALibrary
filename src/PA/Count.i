...
PASize PACountSize()
{
    ...
    __builtin___sprintf_chk (size->value, 0, __builtin_object_size (size->value, 2 > 1 ? 1 : 0), "%c",sizeValue);
    __builtin___sprintf_chk (size->digits, 0, __builtin_object_size (size->digits, 2 > 1 ? 1 : 0), "%d",digits);
    size->size = 4;
