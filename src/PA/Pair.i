...
# 1 "include/PA/Pair.h" 1
          ...
          struct PAPair PAPairPerformInit(struct PAPair p);



          struct PAPair PAPairPerformRuin(struct PAElement Node, struct PAElement Neight);
...
PAResult PAPairPerformPutNeigh(struct PAPair Pair)
{
 ...
 return result;
          ...
          struct PAPair PAPairPerformRuin(struct PAElement Node, struct PAElement Neigh)
{
    struct PAPair Empty;
    return Empty;
          ...
          struct PAPair PAPairPerformDelete(struct PAPair Pair)
{
    return Pair;
