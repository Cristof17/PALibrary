...
# 5 "include/PA/Resource.h" 2
          ...
          struct PAResource PAResourcePerformInit(struct PAResource Resource, struct PANumber Number);
          struct PAResource PAResourcePerformConstruct(struct PANumber Number);
          struct PAResource PAResourcePerformRuin(struct PANumber Number);
