...
# 7 "include/ArrayList/ArrayList.h" 2
          ...
          struct ArrayList ArrayListPerformConstruct(ArrayListObject Data[], ArrayListPosition);
...
# 84 "src/ArrayList/ArrayList.c"
ArrayListSize ArrayListPerformSize()
{
 ArrayListSize first;
 return first;
# 99 "src/ArrayList/ArrayList.c"
}
