...
# 13 "include/ArrayList/ArrayListPosition.h" 2
          ...
          ArrayListPosition ArrayListPositionPerformConstruct(ArrayListPosition);
          ArrayListPosition ArrayListPositionPerformInit(ArrayListPosition);
          ArrayListPosition ArrayListPositionPerformCopy(ArrayListPosition);
          PAResult ArrayListPositionPerformDelete(ArrayListPosition);
          PAResult ArrayListPositionPerformRuin(ArrayListPosition);
...
{
 ArrayListPosition position = { ((int)1) };
 return position;
}
