...
# 7 "include/ArrayList/ArrayList.h" 2
          ...
          PAResult ArrayListPerformCopy(struct ArrayList, struct PAList);
          PAResult ArrayListPerformCopyTo(struct ArrayList Dest, struct PAList source);
...
# 7 "include/PA/List.h" 2
          ...
          PAResult PAListPerformPutCount(struct PAList, struct PACount);
