...
# 9 "include/PA/Tree.h" 2
          ...
          struct PATree PATreePerformRuin(struct PACount n, struct PACount m, struct PASeries adj[], struct PAElement sursa);
          struct PATree PATreePerformDelete(struct PATree);
# 11 "src/Adapter/Client.c" 2
# 1 "include/Adapter/Target.h" 1
# 15 "include/Adapter/Target.h"
# 1 "include/PA/Series.h" 1
# 17 "include/PA/Series.h"
          struct PASeries PASeriesPerformConstruct(struct PACount n, struct PAList adj[]);
          struct PASeries PASeriesPerformInit(struct PASeries s, struct PACount n, struct PAList adj[]);
          struct PASeries PASeriesPerformDelete(struct PASeries Series);
          struct PASeries PASeriesPerformRuin(struct PACount n, struct PAList adj[]);
# 16 "include/Adapter/Target.h" 2
# 1 "include/Adapter/Adapter.h" 1
# 18 "include/Adapter/Adapter.h"
          void AdapterRequest();
          void AdapterHead();
          struct PAElement GetHead(struct Adapter);
# 17 "include/Adapter/Target.h" 2
# 1 "include/Adapter/Target.h" 1
# 18 "include/Adapter/Target.h" 2
# 27 "include/Adapter/Target.h"
