# 1 "src/Flyweight/FlyweightFactory.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 418 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "src/Flyweight/FlyweightFactory.c" 2
# 1 "include/Flyweight/FlyweightFactory.h" 1
# 2 "src/Flyweight/FlyweightFactory.c" 2
...
# 3 "src/Flyweight/FlyweightFactory.c" 2
# 1 "include/Flyweight/Flyweight.h" 1
# 4 "src/Flyweight/FlyweightFactory.c" 2


struct FlyweightFlyweight GetFlyweight(struct PAData data)
{
    struct FlyweightFlyweight flyweight;
    return flyweight;
