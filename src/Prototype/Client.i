# 1 "src/Prototype/Client.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 466 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "src/Prototype/Client.c" 2

# 1 "include/Prototype/Client.h" 1
...
# 5 "include/Prototype/Client.h" 2


          struct PrototypePrototype Operation();
# 3 "src/Prototype/Client.c" 2
