...
# 11 "include/PA/List.h"
          struct PAList PASeriesPerformConstruct(struct PACount n, struct PASeries series);
          struct PAList PAListPerformInit(struct PAList);



          struct PAList PAListPerformRuin(struct PACount n, struct PASeries);
          struct PAList PAListPerformDelete(struct PACount, struct PASeries PA);
# 7 "src/BFS/Record.c" 2
# 1 "include/PA/Count.h" 1
# 14 "include/PA/Count.h"
          struct PACount PACountPerformConstruct(PAInt value);
          struct PACount PACountPerformInit(struct PACount value);



          struct PACount PACountPerformRuin(PAInt value);


          int PACountPerformDelete(struct PACount PA);
